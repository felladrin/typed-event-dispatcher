...
function addListener<T>(listener: TypedEventListener<T>): void;
...
export class TypedEventDispatcher<T = undefined> {
  public readonly getter: TypedEvent<T> = { addListener: addListener.bind(this), removeListener: removeListener.bind(this) };
